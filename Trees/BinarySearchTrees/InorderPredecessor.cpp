...
TreeNode* create(vector<int>v){//leetcode 701
    TreeNode* root=NULL;
...
int inorderpredecessor(TreeNode* root,int val,TreeNode* node,TreeNode* pred){
...
int main(){
    ...
    cout<<"inorder predecessor of "<<val<<" is:";
    cout<<inorderpredecessor(root,val,node,pred);
}